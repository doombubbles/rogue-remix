...
namespace DiffMatchPatch
{
    ...
    public class diff_match_patch
    {
        ...
        public Object[] diff_linesToWords(string text1, string text2)
        {
            var lineArray = new List<string>();
            Dictionary<string, int> lineHash = new Dictionary<string, int>();
            // e.g. linearray[4] == "Hello\n"
            ...
            // Allocate 2/3rds of the space for text1, the rest for text2.
            var chars1 = diff_linesToWordsMunge(text1, lineArray, lineHash, 40000);
            var chars2 = diff_linesToWordsMunge(text2, lineArray, lineHash, 65535);
            return new Object[] {chars1, chars2, lineArray};
        }
            ...
            Dictionary<string, int> lineHash, int maxLines)
        {
            ...
            while (lineEnd < text.Length - 1)
            {
                lineEnd = text.IndexOfAny([' ', ',', '.', '%'], lineStart);
                if (lineEnd == -1)
                {
                    lineEnd = text.Length - 1;
                }
